...
namespace MyPhotos.Controllers
{
    public class ImageController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImageId,Title,ImageFile,Tags")] ImageModel imageModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageId,Title,ImageName,Tags")] ImageModel imageModel)
        {
